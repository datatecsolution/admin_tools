...
import controlador.CtlMenuPrincipalFrame;
...
public class ViewMenuPrincipalFrame extends JFrame{
	...
	public ViewMenuPrincipalFrame() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(ViewMenuPrincipalFrame.class.getResource("/view/recursos/logo-admin-tool1.png")));
