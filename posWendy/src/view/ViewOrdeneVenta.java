...
public class ViewOrdeneVenta extends JDialog {
	...
	public ViewOrdeneVenta(Window view) {
		...
		super(view,"Ordenes de ventas",Dialog.ModalityType.DOCUMENT_MODAL);
		setIconImage(Toolkit.getDefaultToolkit().getImage(ViewOrdeneVenta.class.getResource("/view/recursos/logo-admin-tool1.png")));
		...
		lblLogo = new JLabel("");
		lblLogo.setIcon(new ImageIcon(ViewOrdeneVenta.class.getResource("/view/recursos/logo_facturar.png")));
		panel_2.add(lblLogo);
